...
function indexOfItems(array, include) {
    return array.indexOf(include);
}
;
function lastIndexOfItems(array, include) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, calcNumbers(index)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    if (!(!includesItems(calcule.calcAll, 'x') && !includesItems(calcule.calcAll, '/'))) return [3 /*break*/, 9];
